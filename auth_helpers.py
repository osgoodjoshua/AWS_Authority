...
AUTH0_DOMAIN = st.secrets.get("AUTH0_DOMAIN") or os.getenv("AUTH0_DOMAIN")
AUTH0_CLIENT_ID = st.secrets.get("AUTH0_CLIENT_ID") or os.getenv("AUTH0_CLIENT_ID")
AUTH0_CLIENT_SECRET = st.secrets.get("AUTH0_CLIENT_SECRET") or os.getenv("AUTH0_CLIENT_SECRET")
AUTH0_CALLBACK_URL = st.secrets.get("AUTH0_CALLBACK_URL") or os.getenv("AUTH0_CALLBACK_URL")
AUTH0_LOGOUT_URL = st.secrets.get("AUTH0_LOGOUT_URL") or os.getenv("AUTH0_LOGOUT_URL")
